...
# plot
#y1 =apply(cum.regret.M_UCB.matrix,2,function(x){quantile(x,0.5)})
...
mean(cum.regret.RM_UCB1.matrix[,T.times])
sd(cum.regret.RM_UCB1.matrix[,T.times])
mean(cum.regret.RM_UCB3.matrix[,T.times])
sd(cum.regret.RM_UCB3.matrix[,T.times])
mean(cum.regret.RM_UCB4.matrix[,T.times])
sd(cum.regret.RM_UCB4.matrix[,T.times])
